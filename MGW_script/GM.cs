...
public class GM : MonoBehaviour
{
    ...
    public GameObject[] banr=new GameObject[9];
    ...
    IEnumerator gamestart(){
        ...
        for(int i=0;i<5;i++){
            ...
            if(sw.cid<52){
                ...
                /*switch(sw.cid%13){
                    case 0:cnum[i]=2; break;
                    case 1:cnum[i]=3; break;
                    case 2:cnum[i]=4; break;
                    case 3:cnum[i]=5; break;
                    case 4:cnum[i]=6; break;
                    case 5:cnum[i]=7; break;
                    case 6:cnum[i]=8; break;
                    case 7:cnum[i]=9; break;
                    case 8:cnum[i]=10; break;
                    case 9:cnum[i]=11; break;
                    case 10:cnum[i]=12; break;
                    case 11:cnum[i]=13; break;
                    case 12:cnum[i]=14; break;
                    default: break;
                }
                if(sw.cid>=0 && sw.cid<=12){
                    suit[i]=1;
                }else if(sw.cid>=13 && sw.cid<=25){
                    suit[i]=2;
                }else if(sw.cid>=26 && sw.cid<=38){
                    suit[i]=3;
                }else if(sw.cid>=39 && sw.cid<=51){
                    suit[i]=4;
                }*/
            }else{
                cnum[i]=99;
    ...
    int judge(){
        int yk=0,pairs=0,Mrn=0,cMax=0,cMin=15;
