...
public class Reelctrl2_3 : MonoBehaviour
{
    public int spinF,PofS,r;
    public int[] mark=new int[3];
    int[] inmk={0,1,0,10,0,2,0,88,0,1,0,0,50,0,2,0,999,0,3,0,0,88,0,1};
    ...
    void RCC(){
        if(gamemaster.Lines==1){
            if(RC1.mark[1]==88 && mark[1]==88){
                RC3.spinF=6;
            }else{
                RC3.spinF=2;
            }
        }else if(gamemaster.Lines==3){
            if((RC1.mark[1]==88 && mark[1]==88) || (RC1.mark[2]==88 && mark[2]==88) || (RC1.mark[0]==88 && mark[0]==88)){
                RC3.spinF=6;
            }else{
                RC3.spinF=2;
            }
        }else if(gamemaster.Lines==5){
            if((RC1.mark[1]==88 && mark[1]==88) || (RC1.mark[2]==88 && mark[2]==88) || (RC1.mark[0]==88 && mark[0]==88) || (RC1.mark[2]==88 && mark[1]==88) || (RC1.mark[0]==88 && mark[1]==88)){
                RC3.spinF=6;
            }else{
                RC3.spinF=2;
            }
        }else if(gamemaster.Lines==9){
            if((RC1.mark[1]==88 && mark[1]==88) || (RC1.mark[2]==88 && mark[2]==88) || (RC1.mark[0]==88 && mark[0]==88) || (RC1.mark[2]==88 && mark[1]==88) || (RC1.mark[0]==88 && mark[1]==88) || (RC1.mark[1]==88 && mark[2]==88) || (RC1.mark[1]==88 && mark[0]==88)){
                RC3.spinF=6;
            }else{
                RC3.spinF=2;
            }
        }else if(gamemaster.Lines==15){
            if((RC1.mark[1]==88 && mark[1]==88) || (RC1.mark[2]==88 && mark[2]==88) || (RC1.mark[0]==88 && mark[0]==88) || (RC1.mark[2]==88 && mark[1]==88) || (RC1.mark[0]==88 && mark[1]==88) || (RC1.mark[1]==88 && mark[2]==88) || (RC1.mark[1]==88 && mark[0]==88) || (RC1.mark[2]==88 && mark[0]==88) || (RC1.mark[0]==88 && mark[2]==88)){
                RC3.spinF=6;
            }else{
                RC3.spinF=2;
            }
