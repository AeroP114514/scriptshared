...
{   //FD Super Deuces Wild
    ...
    bool inFG=false,inDJ=false,skip2;
    ...
    void Update()
    {
        ...
        if(GameMode==255){
            ...
            if(FGrem>0){
                ...
                StartCoroutine("gamestart");
                guidance.text="During Free Game, All Winnings Pay at Doubled.";
            }else{
                GameMode=256;
                dealspeed=0.22f;
                win=FGwin;
