...
public class Reelctrl3_4 : MonoBehaviour
{
    public int spinF,PofS,r;
    public int[] mark=new int[3];
    int[] mdef={999,4,1,1,1,8,2,5,1,4,2,3,8,6,6,6,4,3,3,5,2,8,2,7,1,1,88,2,5,5,1,6,7,4,7,3,2,6,3,5,999,4}; //初期値
    int[] inmk={999,4,1,1,1,8,2,5,1,4,2,3,8,6,6,6,4,3,3,5,2,8,2,7,1,1,88,2,5,5,1,6,7,4,7,3,2,6,3,5,999,4};
    ...
    public AudioClip SFX,SFX1,SFX2,SFX3;
    AudioSource snd;
    ...
    void RCC(){
        ...
        if(sens){
            switch(cnt){
                case 1: snd.PlayOneShot(SFX1); break;
